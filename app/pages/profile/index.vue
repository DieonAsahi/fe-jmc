...
const passwordErrors = computed(() => {
  ...
  if (!/[!@#$%^&*(),.?":{}|<>]/.test(form.password))
    errs.push("Harus ada karakter khusus");
  return errs;
});
      ...
      <template v-else-if="profile">
        ...
        <div v-else class="card">
            ...
            <div class="mb-3">
              <label class="form-label"
                ...
                <small class="text-secondary"
                  >(kosongkan jika tidak ingin ganti)</small
                ></label
              >
              ...
              <ul
                ...
                class="mt-2 mb-0 small text-danger"
              >
          ...
          <div class="card-footer d-flex gap-2">
            ...
            <button class="btn btn-outline-secondary" @click="batal">
              Batal
            </button>
          </div>
        </div>
